...
object Scheme extends Enumeration {
  ...
  val Business, Commercial, DigitalAndTechnology, Finance, ProjectDelivery, NewScheme = Value

  val AllSchemes = List(Business, Commercial, DigitalAndTechnology, Finance, ProjectDelivery, NewScheme)
