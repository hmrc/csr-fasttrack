...
class LocationsSchemesJsonRepositorySpec extends IntegrationSpec with MockitoSugar with OneAppPerSuite {
  val DateFormat = "d/M/yy"

  "Locations and Scheme Repository" should {
    "list of schemes and locations ordered by" in {
